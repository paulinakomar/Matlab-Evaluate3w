function EvaluationOf3wResults_gui = EvaluationOf3wResults_gui(dRdT_rawData, VoltageCurrentPixel, RawData_3w, folder, name, power, l, b, thickness, n, save_pdf, save_png, resolution, new)
...
[dRdT_val] = dRdT(dRdT_rawData, dRdT_fitPlotsPdf_png, XlsFileName,...
    save_pdf, save_png, resolution, new);
