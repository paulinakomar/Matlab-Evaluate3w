...
function pushbutton1_Callback(hObject, eventdata, handles)
    pathname_thick = uigetdir('\\fs01\holuj$\Dokumente\Results\3Omega\SL-TH');
...
function pushbutton2_Callback(hObject, eventdata, handles)
    pathname_ref = uigetdir('\\fs01\holuj$\Dokumente\Results\3Omega\SL-TH');
...
inputParameters.folder = {get(handles.text3, 'String'), get(handles.text5, 'String')};
inputParameters.name = {get(handles.edit1, 'String'), get(handles.edit5, 'String'), ...
                    get(handles.edit7, 'String'), get(handles.edit9, 'String')};
inputParameters.number = {get(handles.edit2, 'String'), get(handles.edit6, 'String'), ...
                    get(handles.edit8, 'String'), get(handles.edit10, 'String')};
                
        PixelWidth(inputParameters);
